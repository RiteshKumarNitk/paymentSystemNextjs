    ...
    return (
        <main className="mx-auto min-h-screen max-w-3xl px-4 py-12">
            <div className="mb-10">
                ...
                <h1 className="mt-4 text-4xl font-black text-slate-900 tracking-tight">Schedule New Event</h1>
                <p className="text-slate-500 font-medium">Create a new experience for the {tenantSlug} community.</p>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <p className="mt-2 text-[10px] font-bold text-slate-400 text-center uppercase">0 = Public (Free)</p>
                        </div>
                        <div>
                            <label className="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Guest Capacity</label>
                            <input name="capacity" type="number" min="0" defaultValue="0"
                                className="w-full rounded-2xl border-2 border-slate-50 bg-slate-50 px-5 py-4 font-bold text-slate-900 focus:border-indigo-500 focus:bg-white focus:outline-none transition-all" />
                            <p className="mt-2 text-[10px] font-bold text-slate-400 text-center uppercase">0 = Unlimited</p>
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4 py-4 px-6 rounded-2xl bg-slate-50 border border-slate-100">
                        ...
                        <div className="">
                            ...
                            <p className="text-xs text-slate-400 font-medium">If enabled, members can immediately view and book this event.</p>
                        </div>
                    </div>
                </div>
